...
const en = {
  ...
  showScreenshots: 'Show task screenshots', showScreenshotsHint: 'Off by default. Requests base64 step screenshots and stores validated images in Harness attachments for Web UI display.',
...
const zh = {
  ...
  showScreenshots: '显示任务截图', showScreenshotsHint: '默认关闭。开启后请求 Base64 步骤截图，并将通过校验的图片存入 Harness attachments，在网页界面中显示。',
