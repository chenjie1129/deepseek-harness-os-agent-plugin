...
function taskHistoryFromMeta(meta) {
  if (!isRecord(meta)) return { steps: [] };
  const steps = Array.isArray(meta.osAgentSteps) ? meta.osAgentSteps.flatMap((value) => isTaskStep(value) ? [value] : []).slice(0, 500) : [];
  const total = meta.osAgentReportedTotalSteps;
  return {
    steps,
    ...typeof total === "number" && Number.isSafeInteger(total) && total >= 0 ? { reportedTotalSteps: total } : {}
  };
}
...
function isImageDataUrl(value, mediaType) {
  if (typeof value !== "string" || typeof mediaType !== "string" || value.length > 7e6) return false;
  const prefix = `data:${mediaType};base64,`;
  if (!value.startsWith(prefix)) return false;
  const encoded = value.slice(prefix.length);
  return encoded.length > 0 && encoded.length % 4 !== 1 && /^[A-Za-z0-9+/]*={0,2}$/.test(encoded);
}
function isTaskStep(value) {
  if (!isRecord(value)) return false;
  return positiveInteger(value.sequence) && typeof value.action === "string" && value.action !== "" && value.action.length <= 128 && (value.stepId === void 0 || typeof value.stepId === "string" && value.stepId.length <= 512) && (value.timestamp === void 0 || typeof value.timestamp === "string" && value.timestamp.length <= 64) && (value.success === void 0 || typeof value.success === "boolean") && (value.summary === void 0 || typeof value.summary === "string" && value.summary.length <= 500);
}
...
function OsAgentResultCard(props) {
  ...
  const screenshots = (0, import_react.useMemo)(
    () => result === void 0 ? [] : screenshotsFromMeta(result.meta),
    [result]
  );
  ...
  const previewById = (0, import_react.useMemo)(
    () => new Map(screenshots.map((screenshot) => [String(screenshot.attachment.attachmentId), screenshot.dataUrl])),
    [screenshots]
  );
  const load = (0, import_react.useCallback)(
    (attachment) => Promise.resolve(previewById.get(String(attachment.attachmentId))).then((dataUrl) => dataUrl ?? props.loadOsAgentImage(props.sessionId, attachment)),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "osa-tool-result", "data-failed": failed || void 0, "aria-label": props.t("resultCard"), children: [
    ...
    screenshots.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "osa-tool-result-images", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_attachment.ImageGallery, { images: screenshots.map((screenshot) => ({ attachment: screenshot.attachment })), load, align: "start", labels }) }) : null,
    history.steps.length > 0 || history.reportedTotalSteps !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "osa-tool-result-steps", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "osa-tool-result-steps-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: props.t("taskSteps") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: props.t("observedSteps").replace("{count}", String(history.steps.length)) })
      ] }),
      history.steps.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", { children: history.steps.map((step) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: step.action }),
          step.success === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { "data-success": step.success, children: props.t(step.success ? "stepSucceeded" : "stepNotSucceeded") }),
          step.timestamp === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("time", { dateTime: step.timestamp, children: step.timestamp })
        ] }),
        step.summary === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: step.summary })
      ] }, `${step.sequence}:${step.stepId ?? step.action}`)) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "osa-muted", children: props.t("historyUnavailable") }),
      history.reportedTotalSteps === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "osa-tool-result-total", children: props.t("reportedTotalSteps").replace("{count}", String(history.reportedTotalSteps)) })
    ] }) : null,
...
var en = {
  ...
  showScreenshotsHint: "Off by default. Captures validated step screenshots as Harness attachments for Web UI display.",
  ...
  observedSteps: "{count} observed",
  reportedTotalSteps: "Volcengine reported {count} agent steps.",
  stepSucceeded: "Succeeded",
  stepNotSucceeded: "Pending / failed",
  historyUnavailable: "Historical current-step snapshots are unavailable for this completed run.",
...
var zh = {
  ...
  showScreenshotsHint: "\u9ED8\u8BA4\u5173\u95ED\u3002\u5F00\u542F\u540E\u6355\u83B7\u4EFB\u52A1\u6B65\u9AA4\u622A\u56FE\uFF0C\u5E76\u5C06\u901A\u8FC7\u6821\u9A8C\u7684\u56FE\u7247\u5B58\u5165 Harness attachments\uFF0C\u5728\u7F51\u9875\u754C\u9762\u4E2D\u663E\u793A\u3002",
  tosBucket: "TOS Bucket",
  tosEndpoint: "TOS Endpoint",
  tosRegion: "TOS Region",
  ...
  inspect: "\u68C0\u67E5\u8BE6\u60C5",
  taskSteps: "\u4EFB\u52A1\u6B65\u9AA4",
  observedSteps: "\u5DF2\u6355\u83B7 {count} \u6761",
  reportedTotalSteps: "\u706B\u5C71\u5F15\u64CE\u62A5\u544A\u5171 {count} \u4E2A Agent \u6B65\u9AA4\u3002",
  stepSucceeded: "\u6210\u529F",
  stepNotSucceeded: "\u8FDB\u884C\u4E2D / \u5931\u8D25",
  historyUnavailable: "\u8BE5\u5DF2\u5B8C\u6210\u4EFB\u52A1\u6CA1\u6709\u53EF\u7528\u7684\u5386\u53F2\u5F53\u524D\u6B65\u9AA4\u5FEB\u7167\u3002",
  openScreenshot: "\u6253\u5F00\u622A\u56FE",
